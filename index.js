...
/////////////////
const BotName = 'RIFF BOT☄'; 
const instagram = 'https://instagram.com/arif ponco wicaksono'; 
const telegram = 'https://t.me/redzy'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/RIFF';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@arif ponco wicaksono')
